...
This option controls aerosol dry deposition
  ...
  - 1 (GOCART aerosols, recommended): Dry deposition is enabled for aerosols. Calculates dry deposition velocities with the GOCART model formulation in gocart_drydep, not including the contribution of gravitational settling to dry deposition at the surface. Use with aer_settling_opt = 3 (recommended) or 1.
